  ...
  return (
    <div name='home' className='h-screen w-full bg-gradient-to-b from-black to-gray-600'>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center h-full px-4 md:flex-row'>
            <div className='flex flex-col mt-10 justify-center h-full md:mr-4'>
                <h2 className='text-4xl sm:text-7xl font-bold text-gray-400 md:text-left'>
                    I am a WordPress Developer & SEO Specialist.
                </h2>
                <p className='text-slate-300 py-4 max-w-md md:text-left'>I am an experienced WordPress Developer specializing in crafting visually stunning and highly functional websites optimized for SEO. With expertise in HTML, CSS, and Javascript. I create responsive designs that captivate users and drive traffic. Explore my portfolio to see the fusion of creativity and technical prowess defining my work.</p>
